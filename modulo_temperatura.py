def mostrar_formulario_temperatura(conectar_sit_hh, cr_timezone):
    ...
    # Conexión a hoja de temperatura
    hoja = conectar_sit_hh().worksheet("TTemperatura")

    # Fecha y hora actual en formato CRC
    ...
    # Obtener usuario y nombre desde hoja "usuarios"
    ...
    # Rango definido por tipo de contenedor
    ...
    # Dispositivo (si está disponible en sesión)
