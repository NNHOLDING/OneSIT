    ...
    if st.session_state["datos_sku"] is not None:
        ...
        if formato == "CSV":
            ...
            try:
                ...
                centered_title = ParagraphStyle(name="CenteredTitle", fontSize=18, alignment=1, spaceAfter=10)
                centered_subtitle = ParagraphStyle(name="CenteredSubtitle", fontSize=12, alignment=1, spaceAfter=6)
